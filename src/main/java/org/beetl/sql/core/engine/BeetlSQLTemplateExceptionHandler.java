...
public class BeetlSQLTemplateExceptionHandler extends ConsoleErrorHandler {
    private static Logger log = LogManager.getLogger(BeetlSQLTemplateExceptionHandler.class);
    ...
    public void processExcption(BeetlException ex, Writer writer) {
        ...
        StringBuilder sb = new StringBuilder(">>").append(getDateTime())
                .append(":")
                .append(error.getType())
                .append(":")
                .append(error.getErrorTokenText())
                .append(" 位于")
                .append(line + startLine - 1)
                .append("行")
                .append(" 资源:")
